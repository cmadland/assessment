...
- First paper held back until second paper Proposal
- proposal for paper 2 [DATE]
- paper 2 Timeline
...
- [OTESSA Journal](https://journal.otessa.org/index.php/oj)  
    - 4000-7000 words  
    - APC - None  
...
suggested outline
- line spacing
- add links to other 3-paper projects resources
- rationale for 3-paper dissertation